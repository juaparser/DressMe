...
class ColorAdapter(context: Context, list: Array<com.juaparser.dressme.database.Color>) :ArrayAdapter<com.juaparser.dressme.database.Color>(
    context,
    0,
    list
) {
    ...
    private var colorList: Array<com.juaparser.dressme.database.Color> = list
