...
class ConjuntosAdapter(var ctx: Context, private val values: MutableList<Conjunto>)
    ...
    private lateinit var item: Conjunto
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        view.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.nav_verConjunto, bundle)
        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        doAsync {
            DressMeApp.database.ConjuntoPrendaDao().getConjuntoConPrendas(item.conjuntoId)
        }
    }
